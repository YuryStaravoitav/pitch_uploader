...
public class PitchUploadController extends BasePitchController {
    ...
    public String uploadFile(@RequestParam("file") MultipartFile file, RedirectAttributes redirectAttributes, Model model) throws IOException, InterruptedException {
